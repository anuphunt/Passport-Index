...
namespace passportapi.Controllers
{
    ...
    public class PassportInfoController : ControllerBase
    {
        ...
        public async Task<IEnumerable<PassportInfoResource>> GetAllAsync()
        {
            ...
            var resources = _mapper.Map<IEnumerable<PassportInfo>, IEnumerable<PassportInfoResource>>(passportInfo);
        ...
        public async Task<PassportInfoResource> GetById(int id)
        {
            ...
            var resources = _mapper.Map<PassportInfo, PassportInfoResource>(passportInfo);
            return resources;
        }
        ...
        public async Task<IActionResult> PostAsync([FromBody] SavePassportInfoResource resource)
        {
            ...
            var passportInfo = _mapper.Map<SavePassportInfoResource, PassportInfo>(resource);
            var result = await _passportInfoService.SaveAsync(passportInfo);

            if (!result.Success)
                return BadRequest(result.Message);

            var passportResource = _mapper.Map<PassportInfo, PassportInfoResource>(result.PassportInfo);
        ...
        public async Task<IActionResult> PutAsync(int id, [FromBody] SavePassportInfoResource resource)
        {
            ...
            var passportinforesource = _mapper.Map<PassportInfo, PassportInfoResource>(result.PassportInfo);
